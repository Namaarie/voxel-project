...
export interface InitOutput {
  ...
  readonly _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h21026e3db273efae: (a: number, b: number) => void;
  readonly closure4740_externref_shim: (a: number, b: number, c: number) => void;
  readonly closure5016_externref_shim: (a: number, b: number, c: number, d: number) => void;
