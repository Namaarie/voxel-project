...
export function closure1269_externref_shim(a: number, b: number, c: number): void;
export function closure1267_externref_shim(a: number, b: number, c: number, d: number): void;
export function _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__hec2f4ee603b6773d(a: number, b: number): void;
export function _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h90729d225c86683b(a: number, b: number): void;
export function closure70804_externref_shim(a: number, b: number, c: number): void;
